...
function PhotoActions({ photo, isLiked, onToggleLike, className = "" }: PhotoActionsProps) {
  return (
          ...
          {displayedPhotos.map((photo, index) => (
            ...
            >
              <div className="flex flex-col sm:flex-row">
                {/* Thumbnail */}
                <div className="relative sm:w-48 shrink-0 aspect-[4/3] sm:aspect-auto sm:h-auto overflow-hidden">
                  <div className={`w-full h-full min-h-[8rem] ${getGradientClass(index)}`} />
                </div>
          ...
          {displayedPhotos.map((photo, index) => (
            ...
            >
              ...
              <div className="relative aspect-[4/3] overflow-hidden">
                ...
                <div className={`w-full h-full ${getGradientClass(index)}`} />
