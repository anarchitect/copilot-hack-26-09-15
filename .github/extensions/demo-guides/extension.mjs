...
// Step-by-step walkthroughs for the Option 2 demo challenges.
//
...
await joinSession({
    canvases: [
        createCanvas({
            ...
            description:
                "Step-by-step walkthroughs for the four Option 2 demo challenges (Features, Engineering Practices, Customize Copilot, Cloud Agent) with per-step progress tracking.",
            inputSchema: {
                type: "object",
                properties: {
                    guideId: {
