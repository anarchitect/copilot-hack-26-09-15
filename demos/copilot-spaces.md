...
4. Add the description `Implement security best practices for the photo gallery application`
...
10. Add the feature-request issue you created in the previous MCP exercise and press `save`
...
2. Select the owner `Username` OR `OrgName`
3. Select `Create Space`
4. Add the description `Create comprehensive documentation and API design documentation for the photo gallery application`
...
14. Choose the sharing option for the owner:
    - **Organization-owned Space:** Add specific users or teams and assign a role, or set a base role for organization members.
    - **Personal Space:** Add specific GitHub users, or select `Anyone with link` under `General access`.
15. Copy the link and send it to the other group.
...
👉 **[Start GitHub Copilot Cloud Agent Demo](cloud-agent-classic.md)**