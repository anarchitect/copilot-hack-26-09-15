...
- [Demo markdown file](../demos/features-demo-classic.md)
...
Moved to its own guide: **[Stacked Pull Requests](stacked-pull-requests.md)**. Ask Copilot to build a two-PR stack with the `gh stack` extension, then verify GitHub registered a real stack object.
